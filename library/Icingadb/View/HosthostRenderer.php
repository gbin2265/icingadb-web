...
/** @implements ItemTableRenderer<HosthostSummary> */
class HosthostRenderer implements ItemTableRenderer
{
    use Translation;
    use BaseFilter;
     ...
     *
     * @param HosthostSummary $item
     *
     * @return ServiceStatistics
     */
    protected function createStatistics(HosthostSummary $item): ServiceStatistics
    {
