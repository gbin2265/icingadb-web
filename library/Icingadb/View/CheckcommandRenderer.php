...
/** @implements ItemTableRenderer<CheckcommandSummary> */
class CheckcommandRenderer implements ItemTableRenderer
{
    use Translation;
    use BaseFilter;
    ...
    {
        $attributes->get('class')->addValue('checkcommand-group');
    }
     ...
     *
     * @param CheckcommandSummary $item
     *
     * @return ServiceStatistics
     */
    protected function createStatistics(CheckcommandSummary $item): ServiceStatistics
    {
        return (new ServiceStatistics($item))
            ->setBaseFilter(Filter::equal('checkcommand.name', $item->name));
    }
}
