...
/** @implements ItemTableRenderer<ServicegroupprojectSummary> */
class ServicegroupprojectRenderer implements ItemTableRenderer
{
    use Translation;
    use BaseFilter;
     ...
     *
     * @param ServicegroupprojectSummary $item
     *
     * @return ServiceStatistics
     */
    protected function createStatistics(ServicegroupprojectSummary $item): ServiceStatistics
    {
